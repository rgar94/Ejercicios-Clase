	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				llanta.GLrender(NULL, _SHADED, 1.0);//Rueda delantera izquierda
				glPopMatrix();

				glPushMatrix();
				glTranslatef(-6.0, -1.0, -9.5);
				glRotatef(giro_llanta, 1.0, 0.0, 0.0);
				llanta.GLrender(NULL, _SHADED, 1.0);//Rueda trasera derecha
				glPopMatrix();
				...
				glRotatef(giro_llanta, 1.0, 0.0, 0.0);
				glRotatef(180, 0.0, 1.0, 0.0);
				llanta.GLrender(NULL, _SHADED, 1.0);//Rueda trasera izquierda
				glPopMatrix();
			glPopMatrix();
