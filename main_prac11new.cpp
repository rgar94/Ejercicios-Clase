//Semestre 2019 - 2
 ...
 Visual Studio 2017
 Práctica 10
 Manual: Dibujamos con ayuda de un modelo un auto junto a sus llantas, las animamos dentro de la función
 animación, cuidando nuestras conticiones para que el auto se mueva hacia adelante o hacia atras.
 */
#include "texture.h"
#include "figuras.h"
#include "Camera.h"
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].rot2Inc = (KeyFrame[playIndex + 1].rotRodDer - KeyFrame[playIndex].rotRodDer) / i_max_steps;
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	for(int i=0; i<MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].rot2Inc = 0;
		KeyFrame[i].movBrazo = 0;
		KeyFrame[i].movBrazo2 = 0;
		KeyFrame[i].movBrazoInc = 0;
		KeyFrame[i].movBrazo2Inc = 0;
		KeyFrame[i].movCabeza = 0;
		KeyFrame[i].MovCabezaInc = 0;
	}
	//NEW//////////////////NEW//////////////////NEW///////////
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			rotRodDer += KeyFrame[playIndex].rot2Inc;
